...
path = os.getcwd() #+ '/Documents/survhive/survhive/tests/test_data'
...
df = pd.read_csv(path+'/test_data/survival_simulation_25.csv')
...
df.to_csv(path+'/test_data/survival_simulation_25_default.csv')


# Scenario 1: Lots of events >0.5 ratio

event = np.random.choice([0, 1], size=25, p=[.2, .8])

df1 = df
df1['event'] = event

df1.to_csv(path+'/test_data/survival_simulation_25_high_event_ratio.csv', index=False)
...
df2.to_csv(path+'/test_data/survival_simulation_25_low_event_ratio.csv', index=False)
...
df3.to_csv(path+'/test_data/survival_simulation_25_first_five_zero.csv', index=False)
...
df4.to_csv(path+'/test_data/survival_simulation_25_last_five_zero.csv', index=False)
...
df5.to_csv(path+'/test_data/survival_simulation_25_all_events.csv', index=False)
...
df5.to_csv(path+'/test_data/survival_simulation_25_no_events.csv', index=False)
