    ...
    **params,
    ...
    for i, alpha in enumerate(alphas):
        ...
        optimiser: Optimiser = Optimiser(
            ...
            line_search_reduction_factor=model.line_search_reduction_factor,
        ...
        if model.warm_start and model.coef_ is not None:
            model.coef_: np.array = optimiser.optimise(
                X=X, y=y, sample_weight=sample_weight, previous_fit=model.coef_
            )
        else:
            model.coef_: np.array = optimiser.optimise(
